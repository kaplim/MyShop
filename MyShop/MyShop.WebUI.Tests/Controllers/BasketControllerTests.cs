    ...
    public class BasketControllerTests
    {
        ...
        public void CanAddBasketItem()
        {
            ...
            IBasketService basketService =
                new BasketService(products, baskets);
            IOrderService orderService = new OrderService(orders);

            var controller = new BasketController(basketService, orderService,
                customers);
            controller.ControllerContext =
                new System.Web.Mvc.ControllerContext(httpContext,
            ...
            // Check productId
            Assert.AreEqual("1", basket.BasketItems.ToList()
        ...
        public void CanGetSummaryViewModel()
        {
            ...
            basket.BasketItems.Add(
                new BasketItem() { ProductId = "1", Quanity = 2 });
            basket.BasketItems.Add(
                new BasketItem() { ProductId = "2", Quanity = 1 });
            ...
            httpContext.Request.Cookies.Add(
                new System.Web.HttpCookie("eCommerceBasket")
                    { Value = basket.Id });
            controller.ControllerContext =
                new System.Web.Mvc.ControllerContext(httpContext,
                    new System.Web.Routing.RouteData(), controller);
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            IPrincipal FakeUser = new GenericPrincipal(
                new GenericIdentity("test@gmail.com", "Forms"), null);
