...
namespace MyShop.Services
{
    public class BasketService : IBasketService
    {
        ...
        private Basket GetBasket(HttpContextBase httpContext,
            bool createIfNull)
        {
            HttpCookie cookie = httpContext.Request.Cookies
                .Get(BasketSessionName);
        ...
        public void AddToBasket(HttpContextBase httpContext, string productId)
        {
            ...
            BasketItem item = basket.BasketItems
        ...
        public void RemoveFromBasket(HttpContextBase httpContext,
            string itemId)
        {
            Basket basket = GetBasket(httpContext, true);
            BasketItem item = basket.BasketItems
        ...
        {
            Basket basket = GetBasket(httpContext, false);
            BasketSummaryViewModel model =
                new BasketSummaryViewModel(0, 0);
